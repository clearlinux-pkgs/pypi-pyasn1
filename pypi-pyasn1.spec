...
Source0  : https://files.pythonhosted.org/packages/4a/a3/d2157f333900747f20984553aca98008b6dc843eb62f3a36030140ccec0d/pyasn1-0.6.0.tar.gz
...
%prep
%setup -q -n pyasn1-0.6.0
cd %{_builddir}/pyasn1-0.6.0
pushd ..
cp -a pyasn1-0.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711505816
